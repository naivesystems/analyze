...
int rule_17_0_1(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_17_0_1::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_17_0_1",
    misra_cpp_2008::rule_17_0_1::libtooling::rule_17_0_1);
