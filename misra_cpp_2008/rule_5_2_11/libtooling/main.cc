...
#include "misra_cpp_2008/rule_5_2_11/libtooling/checker.h"
#include "misra_cpp_2008/rule_5_2_11/libtooling/lib.h"
...
int rule_5_2_11(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_5_2_11::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule_5_2_11 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_5_2_11",
    misra_cpp_2008::rule_5_2_11::libtooling::rule_5_2_11);
