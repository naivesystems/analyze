...
#include "misra_cpp_2008/rule_2_7_2/libtooling/lib.h"
...
int rule_2_7_2(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_2_7_2::libtooling::CommentChecker checker(&all_results);
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 2.7.2 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_2_7_2",
    misra_cpp_2008::rule_2_7_2::libtooling::rule_2_7_2);
