...
#include "misra_cpp_2008/rule_14_6_2/libtooling/lib.h"
...
int rule_14_6_2(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_14_6_2::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 14.6.2 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_14_6_2",
    misra_cpp_2008::rule_14_6_2::libtooling::rule_14_6_2);
