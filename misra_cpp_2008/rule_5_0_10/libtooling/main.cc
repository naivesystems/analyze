...
#include "misra_cpp_2008/rule_5_0_10/libtooling/lib.h"
...
int rule_5_0_10(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_5_0_10::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 5.0.10 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_5_0_10",
    misra_cpp_2008::rule_5_0_10::libtooling::rule_5_0_10);
