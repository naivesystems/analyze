...
#include "misra_cpp_2008/rule_0_1_4/libtooling/lib.h"
...
int rule_0_1_4(int argc, char** argv) {
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_0_1_4",
    misra_cpp_2008::rule_0_1_4::libtooling::rule_0_1_4);
