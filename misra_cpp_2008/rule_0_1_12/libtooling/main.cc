...
#include "misra_cpp_2008/rule_0_1_12/libtooling/lib.h"
...
int rule_0_1_12(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_0_1_12::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 0.1.12 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_0_1_12",
    misra_cpp_2008::rule_0_1_12::libtooling::rule_0_1_12);
