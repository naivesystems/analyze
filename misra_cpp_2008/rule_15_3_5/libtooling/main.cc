...
#include "misra_cpp_2008/rule_15_3_5/libtooling/lib.h"
...
int rule_15_3_5(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_15_3_5::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 15.3.5 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_15_3_5",
    misra_cpp_2008::rule_15_3_5::libtooling::rule_15_3_5);
