...
#include "misra_cpp_2008/rule_15_3_3/libtooling/lib.h"
...
int rule_15_3_3(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_15_3_3::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 3.4.1 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_15_3_3",
    misra_cpp_2008::rule_15_3_3::libtooling::rule_15_3_3);
