...
#include "misra_cpp_2008/rule_18_0_4/libtooling/checker.h"
#include "misra_cpp_2008/rule_18_0_4/libtooling/lib.h"
...
namespace rule_18_0_4 {
namespace libtooling {
int rule_18_0_4(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_18_0_4::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 6.2.2 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_18_0_4",
    misra_cpp_2008::rule_18_0_4::libtooling::rule_18_0_4);
