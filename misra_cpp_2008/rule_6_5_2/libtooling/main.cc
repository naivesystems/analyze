...
#include "misra_cpp_2008/rule_6_5_2/libtooling/lib.h"
...
int rule_6_5_2(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_6_5_2::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 6.5.2 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_6_5_2",
    misra_cpp_2008::rule_6_5_2::libtooling::rule_6_5_2);
