...
#include "misra_cpp_2008/rule_8_4_4/libtooling/lib.h"
...
int rule_8_4_4(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_8_4_4::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 8.4.4 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_8_4_4",
    misra_cpp_2008::rule_8_4_4::libtooling::rule_8_4_4);
