...
#include "misra_cpp_2008/rule_12_1_1/libtooling/lib.h"
...
int rule_12_1_1(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_12_1_1::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 12.1.1 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_12_1_1",
    misra_cpp_2008::rule_12_1_1::libtooling::rule_12_1_1);
