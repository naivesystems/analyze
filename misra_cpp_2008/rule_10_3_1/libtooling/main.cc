...
#include "misra_cpp_2008/rule_10_3_1/libtooling/checker.h"
#include "misra_cpp_2008/rule_10_3_1/libtooling/lib.h"
...
namespace rule_10_3_1 {
namespace libtooling {
int rule_10_3_1(int argc, char** argv) {
  ...
  misra_cpp_2008::rule_10_3_1::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 10.3.1 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "misra_cpp_2008/rule_10_3_1",
    misra_cpp_2008::rule_10_3_1::libtooling::rule_10_3_1);
