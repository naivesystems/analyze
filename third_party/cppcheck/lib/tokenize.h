...
public:
    ...
    /**
     * Check if there is implicit int argument and automatically add implicit int
     * \param argStart The '(' token
     * \param argEnd The ')' token
     * \return true if there is implicit int argument
     */
    bool addImplicitIntTokenForArgument(Token *argStart, Token *argEnd);
