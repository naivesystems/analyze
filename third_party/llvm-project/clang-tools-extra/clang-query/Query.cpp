...
// This code is added since NodeIntrospection.cpp is excluded in BUILD.bazel
namespace clang {
namespace tooling {
...
void dumpLocations(llvm::raw_ostream &OS, DynTypedNode Node, ASTContext &Ctx,
  ...
  // This code is changed since NodeIntrospection.cpp is excluded in BUILD.bazel
  // And function 'GetLocations' is always return {} in
  // clang/lib/Tooling/EmptyNodeIntrospection.inc.in
  //
  // auto Locs = clang::tooling::NodeIntrospection::GetLocations(Node);
  tooling::NodeLocationAccessors Locs = {};
