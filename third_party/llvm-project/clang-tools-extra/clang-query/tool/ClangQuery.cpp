...
// This include path is changed since these header file is in parent folder,
// bazel can't find it by original path
#include "clang-tools-extra/clang-query/Query.h"
#include "clang-tools-extra/clang-query/QueryParser.h"
#include "clang-tools-extra/clang-query/QuerySession.h"
