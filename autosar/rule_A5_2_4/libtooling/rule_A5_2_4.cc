...
#include "autosar/rule_A5_2_4/libtooling/checker.h"
#include "autosar/rule_A5_2_4/libtooling/lib.h"
...
namespace autosar {
namespace rule_A5_2_4 {
namespace libtooling {
int rule_A5_2_4(int argc, char** argv) {
  ...
  autosar::rule_A5_2_4::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A5_2_4 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A5_2_4", autosar::rule_A5_2_4::libtooling::rule_A5_2_4);
}  // namespace
