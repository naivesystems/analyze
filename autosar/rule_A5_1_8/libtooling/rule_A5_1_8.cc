...
#include "autosar/rule_A5_1_8/libtooling/lib.h"
...
int rule_A5_1_8(int argc, char** argv) {
  ...
  autosar::rule_A5_1_8::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule_A5_1_8 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A5_1_8", autosar::rule_A5_1_8::libtooling::rule_A5_1_8);
}  // namespace
