...
#include "autosar/rule_A13_2_1/libtooling/lib.h"
...
int rule_A13_2_1(int argc, char** argv) {
  ...
  autosar::rule_A13_2_1::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A13_2_1", autosar::rule_A13_2_1::libtooling::rule_A13_2_1);
}  // namespace
