...
#include "autosar/rule_A5_1_6/libtooling/checker.h"
#include "autosar/rule_A5_1_6/libtooling/lib.h"
...
namespace autosar {
namespace rule_A5_1_6 {
namespace libtooling {
int rule_A5_1_6(int argc, char** argv) {
  ...
  autosar::rule_A5_1_6::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule_A5_1_6 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A5_1_6", autosar::rule_A5_1_6::libtooling::rule_A5_1_6);
}  // namespace
