...
#include "autosar/rule_A8_4_4/libtooling/checker.h"
#include "autosar/rule_A8_4_4/libtooling/lib.h"
...
int rule_A8_4_4(int argc, char** argv) {
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule_A8_4_4 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A8_4_4", autosar::rule_A8_4_4::libtooling::rule_A8_4_4);
}  // namespace
