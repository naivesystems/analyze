...
#include "autosar/rule_A27_0_3/libtooling/lib.h"
...
int rule_A27_0_3(int argc, char** argv) {
  ...
  autosar::rule_A27_0_3::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A27_0_3 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A27_0_3", autosar::rule_A27_0_3::libtooling::rule_A27_0_3);
}  // namespace
