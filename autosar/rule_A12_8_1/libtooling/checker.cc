...
#include "autosar/rule_A12_8_1/libtooling/checker.h"
    ...
    finder->addMatcher(
        binaryOperation(
            hasAncestor(cxxConstructorDecl(
                anyOf(isMoveConstructor(), isCopyConstructor()),
        ...
        this);
    finder->addMatcher(
        unaryOperator(hasAncestor(cxxConstructorDecl(
                          anyOf(isMoveConstructor(), isCopyConstructor()),
                          hasAncestor(cxxRecordDecl()))),
