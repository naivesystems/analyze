...
#include "autosar/rule_A26_5_2/libtooling/lib.h"
...
int rule_A26_5_2(int argc, char** argv) {
  ...
  autosar::rule_A26_5_2::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A26 5 2 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A26_5_2", autosar::rule_A26_5_2::libtooling::rule_A26_5_2);
}  // namespace
