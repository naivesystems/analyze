...
#include "autosar/rule_A18_5_11/libtooling/lib.h"
...
int rule_A18_5_11(int argc, char** argv) {
  ...
  autosar::rule_A18_5_11::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A18 5 11 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A18_5_11", autosar::rule_A18_5_11::libtooling::rule_A18_5_11);
}  // namespace
