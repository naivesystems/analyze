...
#include "autosar/rule_A15_5_1/libtooling/checker.h"
#include "autosar/rule_A15_5_1/libtooling/lib.h"
...
namespace autosar {
namespace rule_A15_5_1 {
namespace libtooling {
int rule_A15_5_1(int argc, char** argv) {
  ...
  autosar::rule_A15_5_1::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A15 5 1 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A15_5_1", autosar::rule_A15_5_1::libtooling::rule_A15_5_1);
}  // namespace
