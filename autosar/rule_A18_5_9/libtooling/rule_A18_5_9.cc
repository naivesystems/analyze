...
#include "autosar/rule_A18_5_9/libtooling/lib.h"
...
int rule_A18_5_9(int argc, char** argv) {
  ...
  autosar::rule_A18_5_9::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A18 5 9 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A18_5_9", autosar::rule_A18_5_9::libtooling::rule_A18_5_9);
}  // namespace
