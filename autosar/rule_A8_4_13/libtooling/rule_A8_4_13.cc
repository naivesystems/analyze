...
#include "autosar/rule_A8_4_13/libtooling/lib.h"
...
int rule_A8_4_13(int argc, char** argv) {
  ...
  autosar::rule_A8_4_13::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A8 4 13 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A8_4_13", autosar::rule_A8_4_13::libtooling::rule_A8_4_13);
}  // namespace
