...
#include "autosar/rule_A18_5_4/libtooling/lib.h"
#include "lib.h"
...
int rule_A18_5_4(int argc, char** argv) {
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A18_5_4", autosar::rule_A18_5_4::libtooling::rule_A18_5_4);
}  // namespace
