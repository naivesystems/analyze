...
#include "autosar/rule_A5_1_7/libtooling/lib.h"
...
int rule_A5_1_7(int argc, char** argv) {
  ...
  autosar::rule_A5_1_7::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A5_1_7", autosar::rule_A5_1_7::libtooling::rule_A5_1_7);
}  // namespace
