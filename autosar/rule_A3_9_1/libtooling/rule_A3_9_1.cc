...
#include "autosar/rule_A3_9_1/libtooling/lib.h"
...
int rule_A3_9_1(int argc, char** argv) {
  ...
  autosar::rule_A3_9_1::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A3_9_1 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A3_9_1", autosar::rule_A3_9_1::libtooling::rule_A3_9_1);
}  // namespace
