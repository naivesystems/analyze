...
#include "autosar/rule_A3_1_5/libtooling/lib.h"
...
int rule_A3_1_5(int argc, char** argv) {
  ...
  autosar::rule_A3_1_5::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule_A3_1_5 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A3_1_5", autosar::rule_A3_1_5::libtooling::rule_A3_1_5);
}  // namespace
