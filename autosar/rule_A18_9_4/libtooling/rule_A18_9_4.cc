...
#include "autosar/rule_A18_9_4/libtooling/checker.h"
#include "autosar/rule_A18_9_4/libtooling/lib.h"
...
namespace autosar {
namespace rule_A18_9_4 {
namespace libtooling {
int rule_A18_9_4(int argc, char** argv) {
  ...
  autosar::rule_A18_9_4::libtooling::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule A18 9 4 check done";
  }
  return 0;
}
}  // namespace libtooling
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A18_9_4", autosar::rule_A18_9_4::libtooling::rule_A18_9_4);
}  // namespace
