...
#include "autosar/rule_A5_1_9/libtooling/lib.h"
...
int rule_A5_1_9(int argc, char** argv) {
  ...
  autosar::rule_A5_1_9::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _(
    "autosar/rule_A5_1_9", autosar::rule_A5_1_9::libtooling::rule_A5_1_9);
}  // namespace
