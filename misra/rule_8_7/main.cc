...
namespace misra {
namespace rule_8_7 {
int rule_8_7(int argc, char** argv) {
  ...
  misra::rule_8_7::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_8_7",
                                    misra::rule_8_7::rule_8_7);
