...
namespace misra {
namespace rule_17_8 {
int rule_17_8(int argc, char** argv) {
  ...
  misra::rule_17_8::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_17_8",
                                    misra::rule_17_8::rule_17_8);
