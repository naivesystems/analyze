...
namespace misra {
namespace rule_11_8 {
int rule_11_8(int argc, char** argv) {
  ...
  misra::rule_11_8::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_8",
                                    misra::rule_11_8::rule_11_8);
