...
namespace misra {
namespace rule_11_3 {
int rule_11_3(int argc, char** argv) {
  ...
  misra::rule_11_3::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_3",
                                    misra::rule_11_3::rule_11_3);
