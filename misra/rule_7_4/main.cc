...
namespace misra {
namespace rule_7_4 {
int rule_7_4(int argc, char** argv) {
...
podman_image::bigmain::SuffixRule _("misra/rule_7_4",
                                    misra::rule_7_4::rule_7_4);
