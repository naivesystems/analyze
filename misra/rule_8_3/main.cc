...
namespace misra {
namespace rule_8_3 {
int rule_8_3(int argc, char** argv) {
  ...
  misra::rule_8_3::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_8_3",
                                    misra::rule_8_3::rule_8_3);
