...
namespace misra {
namespace rule_11_7 {
int rule_11_7(int argc, char** argv) {
  ...
  misra::rule_11_7::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_7",
                                    misra::rule_11_7::rule_11_7);
