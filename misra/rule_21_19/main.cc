...
#include "misra/rule_21_19/lib.h"
...
int rule_21_19(int argc, char** argv) {
  ...
  misra::rule_21_19::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 21.19 check done";
  }
  return 0;
}
}  // namespace rule_21_19
...
podman_image::bigmain::SuffixRule _("misra/rule_21_19",
                                    misra::rule_21_19::rule_21_19);
