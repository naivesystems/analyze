...
namespace misra {
namespace rule_5_6 {
int rule_5_6(int argc, char** argv) {
  ...
  misra::rule_5_6::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_5_6",
                                    misra::rule_5_6::rule_5_6);
