...
namespace misra {
namespace rule_11_6 {
int rule_11_6(int argc, char** argv) {
  ...
  misra::rule_11_6::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_6",
                                    misra::rule_11_6::rule_11_6);
