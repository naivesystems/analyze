...
namespace misra {
namespace rule_12_3 {
int rule_12_3(int argc, char** argv) {
  ...
  misra::rule_12_3::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_12_3",
                                    misra::rule_12_3::rule_12_3);
