...
namespace misra {
namespace rule_8_2 {
int rule_8_2(int argc, char** argv) {
  ...
  misra::rule_8_2::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_8_2",
                                    misra::rule_8_2::rule_8_2);
