...
namespace misra {
namespace rule_13_3 {
int rule_13_3(int argc, char** argv) {
  ...
  misra::rule_13_3::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_13_3",
                                    misra::rule_13_3::rule_13_3);
