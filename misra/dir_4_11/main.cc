...
namespace misra {
namespace dir_4_11 {
int dir_4_11(int argc, char** argv) {
  ...
  misra::dir_4_11::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/dir_4_11",
                                    misra::dir_4_11::dir_4_11);
