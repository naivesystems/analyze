...
namespace misra {
namespace rule_18_5 {
int rule_18_5(int argc, char** argv) {
  ...
  misra::rule_18_5::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_18_5",
                                    misra::rule_18_5::rule_18_5);
