...
namespace misra {
namespace rule_5_9 {
int rule_5_9(int argc, char** argv) {
  ...
  misra::rule_5_9::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_5_9",
                                    misra::rule_5_9::rule_5_9);
