...
namespace misra {
namespace rule_11_2 {
int rule_11_2(int argc, char** argv) {
  ...
  misra::rule_11_2::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_2",
                                    misra::rule_11_2::rule_11_2);
