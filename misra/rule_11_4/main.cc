...
namespace misra {
namespace rule_11_4 {
int rule_11_4(int argc, char** argv) {
  ...
  misra::rule_11_4::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_4",
                                    misra::rule_11_4::rule_11_4);
