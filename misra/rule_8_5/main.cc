...
namespace misra {
namespace rule_8_5 {
int rule_8_5(int argc, char** argv) {
  ...
  misra::rule_8_5::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_8_5",
                                    misra::rule_8_5::rule_8_5);
