...
#include "misra/rule_21_18/lib.h"
...
int rule_21_18(int argc, char** argv) {
  ...
  misra::rule_21_18::Checker checker;
  ...
  if (misra::proto_util::GenerateProtoFile(all_results, results_path).ok()) {
    LOG(INFO) << "rule 21.18 check done";
  }
  return 0;
}
}  // namespace rule_21_18
...
podman_image::bigmain::SuffixRule _("misra/rule_21_18",
                                    misra::rule_21_18::rule_21_18);
