...
namespace misra {
namespace rule_14_3 {
int rule_14_3(int argc, char** argv) {
  ...
  misra::rule_14_3::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_14_3",
                                    misra::rule_14_3::rule_14_3);
