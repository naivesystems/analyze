...
#include "misra/rule_11_5/checker.h"
#include "misra/rule_11_5/lib.h"
...
namespace misra {
namespace rule_11_5 {
int rule_11_5(int argc, char** argv) {
  ...
  misra::rule_11_5::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_11_5",
                                    misra::rule_11_5::rule_11_5);
