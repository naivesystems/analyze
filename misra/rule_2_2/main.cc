...
namespace misra {
namespace rule_2_2 {
int rule_2_2(int argc, char** argv) {
  ...
  misra::rule_2_2::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_2_2",
                                    misra::rule_2_2::rule_2_2);
