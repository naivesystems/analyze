...
namespace misra {
namespace rule_5_1 {
int rule_5_1(int argc, char** argv) {
...
podman_image::bigmain::SuffixRule _("misra/rule_5_1",
                                    misra::rule_5_1::rule_5_1);
