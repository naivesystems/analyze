...
namespace misra {
namespace rule_13_1 {
int rule_13_1(int argc, char** argv) {
  ...
  misra::rule_13_1::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_13_1",
                                    misra::rule_13_1::rule_13_1);
