...
namespace misra {
namespace rule_17_5 {
int rule_17_5(int argc, char** argv) {
  ...
  misra::rule_17_5::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_17_5",
                                    misra::rule_17_5::rule_17_5);
