...
namespace misra {
namespace rule_5_7 {
int rule_5_7(int argc, char** argv) {
  ...
  misra::rule_5_7::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_5_7",
                                    misra::rule_5_7::rule_5_7);
