...
namespace misra {
namespace rule_14_1 {
int rule_14_1(int argc, char** argv) {
  ...
  misra::rule_14_1::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_14_1",
                                    misra::rule_14_1::rule_14_1);
