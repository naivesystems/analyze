...
namespace misra {
namespace rule_2_3 {
int rule_2_3(int argc, char** argv) {
  ...
  misra::rule_2_3::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_2_3",
                                    misra::rule_2_3::rule_2_3);
