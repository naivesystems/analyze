...
namespace misra {
namespace rule_13_2 {
int rule_13_2(int argc, char** argv) {
  ...
  misra::rule_13_2::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_13_2",
                                    misra::rule_13_2::rule_13_2);
