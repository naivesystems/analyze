...
namespace misra {
namespace rule_8_4 {
int rule_8_4(int argc, char** argv) {
  ...
  misra::rule_8_4::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_8_4",
                                    misra::rule_8_4::rule_8_4);
