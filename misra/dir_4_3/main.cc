...
namespace misra {
namespace dir_4_3 {
int dir_4_3(int argc, char** argv) {
...
podman_image::bigmain::SuffixRule _("misra/dir_4_3", misra::dir_4_3::dir_4_3);
