...
namespace misra {
namespace dir_4_7 {
int dir_4_7(int argc, char** argv) {
...
podman_image::bigmain::SuffixRule _("misra/dir_4_7", misra::dir_4_7::dir_4_7);
