...
namespace misra {
namespace dir_4_12 {
int dir_4_12(int argc, char** argv) {
  ...
  misra::dir_4_12::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/dir_4_12",
                                    misra::dir_4_12::dir_4_12);
