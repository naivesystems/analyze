...
namespace misra {
namespace rule_14_2 {
int rule_14_2(int argc, char** argv) {
  ...
  misra::rule_14_2::Checker checker;
...
podman_image::bigmain::SuffixRule _("misra/rule_14_2",
                                    misra::rule_14_2::rule_14_2);
