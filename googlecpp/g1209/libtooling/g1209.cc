...
#include "googlecpp/g1209/libtooling/lib.h"
...
int g1209(int argc, char** argv) {
  ...
  googlecpp::g1209::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1209",
                                    googlecpp::g1209::libtooling::g1209);
