...
#include "googlecpp/g1195/libtooling/lib.h"
...
int g1195(int argc, char** argv) {
  ...
  googlecpp::g1195::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1195",
                                    googlecpp::g1195::libtooling::g1195);
