...
#include "googlecpp/g1157/libtooling/lib.h"
...
int g1157(int argc, char** argv) {
  ...
  googlecpp::g1157::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1157",
                                    googlecpp::g1157::libtooling::g1157);
