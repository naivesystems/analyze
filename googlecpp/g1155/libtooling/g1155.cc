...
#include "googlecpp/g1155/libtooling/lib.h"
...
extern cl::opt<int> maximum_inline_func_line;

namespace googlecpp {
namespace g1155 {
namespace libtooling {
int g1155(int argc, char** argv) {
  ...
  googlecpp::g1155::libtooling::Checker checker;
  checker.Init(&all_results, maximum_inline_func_line);
  int status = tool.run(
...
podman_image::bigmain::SuffixRule _("googlecpp/g1155",
                                    googlecpp::g1155::libtooling::g1155);
