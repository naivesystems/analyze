...
#include "googlecpp/g1185/libtooling/lib.h"
...
int g1185(int argc, char** argv) {
  ...
  googlecpp::g1185::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1185",
                                    googlecpp::g1185::libtooling::g1185);
