...
#include "googlecpp/g1182/libtooling/lib.h"
...
int g1182(int argc, char** argv) {
  ...
  googlecpp::g1182::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1182",
                                    googlecpp::g1182::libtooling::g1182);
