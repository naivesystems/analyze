...
#include "googlecpp/g1179/libtooling/lib.h"
...
int g1179(int argc, char** argv) {
  ...
  googlecpp::g1179::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1179",
                                    googlecpp::g1179::libtooling::g1179);
