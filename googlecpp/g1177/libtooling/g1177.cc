...
#include "googlecpp/g1177/libtooling/lib.h"
...
int g1177(int argc, char** argv) {
  ...
  googlecpp::g1177::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1177",
                                    googlecpp::g1177::libtooling::g1177);
