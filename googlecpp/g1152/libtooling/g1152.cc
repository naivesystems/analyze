...
#include "googlecpp/g1152/libtooling/lib.h"
...
int g1152(int argc, char** argv) {
  ...
  googlecpp::g1152::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1152",
                                    googlecpp::g1152::libtooling::g1152);
