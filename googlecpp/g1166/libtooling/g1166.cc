...
#include "googlecpp/g1166/libtooling/lib.h"
...
int g1166(int argc, char** argv) {
  ...
  googlecpp::g1166::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1166",
                                    googlecpp::g1166::libtooling::g1166);
