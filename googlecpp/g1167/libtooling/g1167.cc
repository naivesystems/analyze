...
#include "googlecpp/g1167/libtooling/lib.h"
...
int g1167(int argc, char** argv) {
  ...
  googlecpp::g1167::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1167",
                                    googlecpp::g1167::libtooling::g1167);
