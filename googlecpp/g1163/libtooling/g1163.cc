...
#include "googlecpp/g1163/libtooling/lib.h"
...
int g1163(int argc, char** argv) {
  ...
  googlecpp::g1163::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1163",
                                    googlecpp::g1163::libtooling::g1163);
