...
#include "googlecpp/g1178/libtooling/lib.h"
...
int g1178(int argc, char** argv) {
  ...
  googlecpp::g1178::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1178",
                                    googlecpp::g1178::libtooling::g1178);
