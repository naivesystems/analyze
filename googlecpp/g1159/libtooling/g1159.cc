...
#include "googlecpp/g1159/libtooling/lib.h"
...
int g1159(int argc, char** argv) {
  ...
  googlecpp::g1159::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1159",
                                    googlecpp::g1159::libtooling::g1159);
