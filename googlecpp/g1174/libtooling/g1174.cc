...
#include "googlecpp/g1174/libtooling/lib.h"
...
int g1174(int argc, char** argv) {
  ...
  googlecpp::g1174::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1174",
                                    googlecpp::g1174::libtooling::g1174);
