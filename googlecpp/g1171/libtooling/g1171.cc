...
#include "googlecpp/g1171/libtooling/lib.h"
...
int g1171(int argc, char** argv) {
  ...
  googlecpp::g1171::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1171",
                                    googlecpp::g1171::libtooling::g1171);
