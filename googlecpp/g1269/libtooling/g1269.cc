...
#include "googlecpp/g1269/libtooling/lib.h"
...
int g1269(int argc, char** argv) {
  ...
  googlecpp::g1269::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1269",
                                    googlecpp::g1269::libtooling::g1269);
