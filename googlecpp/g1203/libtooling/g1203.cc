...
#include "googlecpp/g1203/libtooling/lib.h"
...
int g1203(int argc, char** argv) {
  ...
  googlecpp::g1203::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1203",
                                    googlecpp::g1203::libtooling::g1203);
