...
#include "googlecpp/g1192/libtooling/lib.h"
...
int g1192(int argc, char** argv) {
  ...
  googlecpp::g1192::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1192",
                                    googlecpp::g1192::libtooling::g1192);
