...
#include "googlecpp/g1180/libtooling/lib.h"
...
int g1180(int argc, char** argv) {
  ...
  googlecpp::g1180::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1180",
                                    googlecpp::g1180::libtooling::g1180);
