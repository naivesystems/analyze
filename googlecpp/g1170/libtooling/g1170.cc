...
#include "googlecpp/g1170/libtooling/lib.h"
...
int g1170(int argc, char** argv) {
  ...
  googlecpp::g1170::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1170",
                                    googlecpp::g1170::libtooling::g1170);
