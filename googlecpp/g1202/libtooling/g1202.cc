...
#include "googlecpp/g1202/libtooling/lib.h"
...
int g1202(int argc, char** argv) {
  ...
  googlecpp::g1202::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1202",
                                    googlecpp::g1202::libtooling::g1202);
