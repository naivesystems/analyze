...
#include "googlecpp/g1169/libtooling/lib.h"
...
int g1169(int argc, char** argv) {
  ...
  googlecpp::g1169::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1169",
                                    googlecpp::g1169::libtooling::g1169);
