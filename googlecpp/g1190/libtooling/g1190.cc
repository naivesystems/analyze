...
#include "googlecpp/g1190/libtooling/lib.h"
...
int g1190(int argc, char** argv) {
  ...
  googlecpp::g1190::libtooling::ASTChecker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1190",
                                    googlecpp::g1190::libtooling::g1190);
