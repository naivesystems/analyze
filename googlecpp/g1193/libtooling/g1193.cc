...
#include "googlecpp/g1193/libtooling/lib.h"
...
int g1193(int argc, char** argv) {
  ...
  googlecpp::g1193::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1193",
                                    googlecpp::g1193::libtooling::g1193);
