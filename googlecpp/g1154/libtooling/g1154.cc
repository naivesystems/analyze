...
#include "googlecpp/g1154/libtooling/lib.h"
...
int g1154(int argc, char** argv) {
  ...
  googlecpp::g1154::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1154",
                                    googlecpp::g1154::libtooling::g1154);
