...
#include "googlecpp/g1194/libtooling/lib.h"
...
int g1194(int argc, char** argv) {
  ...
  googlecpp::g1194::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1194",
                                    googlecpp::g1194::libtooling::g1194);
