...
#include "googlecpp/g1172/libtooling/lib.h"
...
int g1172(int argc, char** argv) {
  ...
  googlecpp::g1172::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1172",
                                    googlecpp::g1172::libtooling::g1172);
