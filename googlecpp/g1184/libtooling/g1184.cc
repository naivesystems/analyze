...
#include "googlecpp/g1184/libtooling/lib.h"
...
int g1184(int argc, char** argv) {
  ...
  googlecpp::g1184::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1184",
                                    googlecpp::g1184::libtooling::g1184);
