...
#include "googlecpp/g1210/libtooling/lib.h"
...
int g1210(int argc, char** argv) {
  ...
  googlecpp::g1210::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1210",
                                    googlecpp::g1210::libtooling::g1210);
