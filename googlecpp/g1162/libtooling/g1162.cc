...
#include "googlecpp/g1162/libtooling/lib.h"
...
int g1162(int argc, char** argv) {
  ...
  googlecpp::g1162::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1162",
                                    googlecpp::g1162::libtooling::g1162);
