...
#include "googlecpp/g1150/libtooling/lib.h"
...
int g1150(int argc, char** argv) {
  ...
  googlecpp::g1150::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1150",
                                    googlecpp::g1150::libtooling::g1150);
