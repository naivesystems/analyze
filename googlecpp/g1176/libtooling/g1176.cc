...
#include "googlecpp/g1176/libtooling/checker.h"
#include "googlecpp/g1176/libtooling/lib.h"
...
int g1176(int argc, char** argv) {
  ...
  googlecpp::g1176::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1176",
                                    googlecpp::g1176::libtooling::g1176);
