...
#include "googlecpp/g1165/libtooling/lib.h"
...
int g1165(int argc, char** argv) {
  ...
  googlecpp::g1165::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1165",
                                    googlecpp::g1165::libtooling::g1165);
