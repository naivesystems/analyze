...
#include "googlecpp/g1211/libtooling/lib.h"
...
int g1211(int argc, char** argv) {
  ...
  googlecpp::g1211::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1211",
                                    googlecpp::g1211::libtooling::g1211);
