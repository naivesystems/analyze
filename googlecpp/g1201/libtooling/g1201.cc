...
#include "googlecpp/g1201/libtooling/lib.h"
...
extern cl::opt<std::string> project_name;

namespace googlecpp {
namespace g1201 {
namespace libtooling {
int g1201(int argc, char** argv) {
  ...
  googlecpp::g1201::libtooling::Checker checker;
  checker.Init(&all_results, project_name);
...
podman_image::bigmain::SuffixRule _("googlecpp/g1201",
                                    googlecpp::g1201::libtooling::g1201);
