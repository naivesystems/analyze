...
#include "googlecpp/g1173/libtooling/lib.h"
...
int g1173(int argc, char** argv) {
  ...
  googlecpp::g1173::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1173",
                                    googlecpp::g1173::libtooling::g1173);
