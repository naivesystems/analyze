...
#include "googlecpp/g1181/libtooling/lib.h"
...
int g1181(int argc, char** argv) {
  ...
  googlecpp::g1181::libtooling::ASTChecker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1181",
                                    googlecpp::g1181::libtooling::g1181);
