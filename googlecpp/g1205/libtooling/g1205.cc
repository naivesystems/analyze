...
#include "googlecpp/g1205/libtooling/lib.h"
...
int g1205(int argc, char** argv) {
  ...
  googlecpp::g1205::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1205",
                                    googlecpp::g1205::libtooling::g1205);
