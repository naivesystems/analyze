...
#include "googlecpp/g1189/libtooling/lib.h"
...
int g1189(int argc, char** argv) {
  ...
  googlecpp::g1189::libtooling::Checker checker;
  checker.Init(&all_results, maximum_allowed_func_line);
  int status = tool.run(
...
podman_image::bigmain::SuffixRule _("googlecpp/g1189",
                                    googlecpp::g1189::libtooling::g1189);
