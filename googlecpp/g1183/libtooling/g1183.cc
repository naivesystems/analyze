...
#include "googlecpp/g1183/libtooling/lib.h"
...
int g1183(int argc, char** argv) {
  ...
  googlecpp::g1183::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1183",
                                    googlecpp::g1183::libtooling::g1183);
