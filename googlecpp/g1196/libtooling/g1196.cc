...
#include "googlecpp/g1196/libtooling/checker.h"
#include "googlecpp/g1196/libtooling/lib.h"
...
int g1196(int argc, char** argv) {
  ...
  googlecpp::g1196::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1196",
                                    googlecpp::g1196::libtooling::g1196);
