...
#include "googlecpp/g1200/libtooling/lib.h"
...
int g1200(int argc, char** argv) {
  ...
  googlecpp::g1200::libtooling::Checker checker;
...
podman_image::bigmain::SuffixRule _("googlecpp/g1200",
                                    googlecpp::g1200::libtooling::g1200);
