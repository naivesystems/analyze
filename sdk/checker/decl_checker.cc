...
#include "sdk/checker/decl_checker.h"
...
class Callback : public sdk::checker::ASTCheckerCallback {
 public:
  Callback(string message, DeclarationMatcher matcher, string bind_id)
  ...
  void run(const MatchFinder::MatchResult& result) override {
    const clang::Decl* decl = result.Nodes.getNodeAs<clang::Decl>(bind_id_);
    string path =
...
void DeclChecker::Init(string name, string message, DeclarationMatcher matcher,
                       string bind_id) {
